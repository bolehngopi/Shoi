...
@export_range(0, 0.2, 0.01) var sway_speed_rotation : float = 0.07
@export_range(0, 0.25, 0.01) var sway_amount_position : float = 0.07
@export_range(0, 50, 0.1) var sway_amount_rotation : float = 0.07
@export var idle_sway_adjusment : float = 10.0
